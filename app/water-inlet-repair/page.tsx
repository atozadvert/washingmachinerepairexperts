...
const SYMPTOMS = [
  {
    ...
    title: 'Machine Not Filling with Water',
    desc: 'You start a cycle but no water enters the drum. The inlet valve may be blocked or faulty.',
  },
  {
    icon: <Gauge className="h-5 w-5" />,
    title: 'Very Slow Water Fill',
    desc: 'The machine fills but takes much longer than normal. A clogged inlet filter or low water pressure is the usual cause.',
  },
  {
    icon: <AlertTriangle className="h-5 w-5" />,
    title: 'Error Code on Display',
    desc: 'Water inlet fault codes like E10, 4E, F8 or IE appear and stop the wash before it starts.',
  },
  {
    icon: <Waves className="h-5 w-5" />,
    title: 'Water Keeps Filling Non-Stop',
    desc: 'The machine does not stop filling and starts to overflow. A stuck-open inlet valve or faulty pressure switch is likely.',
  },
  {
    icon: <Filter className="h-5 w-5" />,
    title: 'Only Hot or Only Cold Water Enters',
    desc: 'One temperature works but the other does not. The hot or cold inlet valve or its wiring may have failed.',
  },
  {
    icon: <RotateCw className="h-5 w-5" />,
    title: 'Water Leaking from Inlet Hose',
    desc: 'Water drips or sprays from where the hose connects to the machine or the tap.',
  },
];

const CAUSES = [
  'Blocked or clogged inlet valve filter screen',
  'Faulty water inlet solenoid valve not opening or closing',
  'Kinked, twisted or damaged inlet hose',
  'Low household water pressure reaching the machine',
  'Broken pressure switch giving wrong water level readings',
  'Corroded hose connector or damaged rubber washer at the tap',
];
...
const PROCESS = [
  {
    ...
    desc: 'Call or message us and we book a same-day slot for your water inlet repair anywhere in Dubai.',
  },
  {
    icon: <Truck className="h-5 w-5" />,
    title: 'Technician Dispatch',
    desc: 'A certified technician arrives with inlet valves, filters, hoses and pressure parts ready.',
  },
  {
    icon: <Search className="h-5 w-5" />,
    title: 'On-Site Diagnosis',
    desc: 'We test the water supply, inlet valve, hose and pressure switch to find the exact fault — then share a clear quote.',
  },
  {
    icon: <Wrench className="h-5 w-5" />,
    title: 'Professional Repair',
    desc: 'The faulty part is replaced using genuine OEM components so your machine fills properly again.',
  },
  {
    icon: <ClipboardCheck className="h-5 w-5" />,
    title: 'Full Cycle Test',
    desc: 'We run a full wash cycle to make sure water fills at the right speed, temperature and level.',
  },
  {
    icon: <BadgeCheck className="h-5 w-5" />,
    title: 'Service Warranty',
    desc: 'Every water inlet repair is backed by a written warranty covering both parts and labour.',
  },
];

const INCLUDED = [
  'Full water inlet valve inspection and test',
  'Inlet filter screen cleaning or replacement',
  'Hose connection and condition check',
  'Water pressure measurement at the machine',
  'Pressure switch calibration test',
  'Full wash cycle fill and level verification',
];
...
const WHY = [
  {
    ...
    desc: 'Most water inlet faults are diagnosed and fixed within a single visit across all Dubai areas.',
  },
  {
...
const FAQS = [
  {
    q: 'How much does a washing machine water inlet repair cost in Dubai?',
    a: 'The cost depends on the fault. We charge an affordable call-out fee and give you a fixed quote on-site before any work begins. No hidden charges.',
  },
  {
    q: 'Can you fix a machine that won\'t fill with water on the same day?',
    a: 'Yes. Most water inlet faults including blocked valves, clogged filters and faulty hoses are fixed in a single same-day visit across Dubai.',
  },
  {
    q: 'Why is my washing machine filling very slowly?',
    a: 'Slow filling is usually caused by a clogged inlet filter, low water pressure or a valve that is not opening fully. Our technician will test and find the exact cause.',
  },
  {
    q: 'Is it safe to use my machine if water keeps filling non-stop?',
    a: 'No. Turn off the tap and switch off the machine. A stuck inlet valve can cause flooding. Call us for a same-day inspection.',
  },
  {
    q: 'Do you provide a warranty on water inlet repairs?',
    ...
    <div className="min-h-screen bg-[#FAF9F5] text-neutral-900 flex flex-col font-sans selection:bg-[#f2b134]/30">
      ...
      <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 sm:pt-16 pb-12 sm:pb-20">
        ...
        <nav className="flex items-center gap-2 text-[13px] text-neutral-500 mb-8 sm:mb-12 font-medium">
          ...
          <ChevronRight className="h-3.5 w-3.5" />
          <span className="text-[#c8901f]">Water Inlet Repair</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          <div className="flex flex-col items-start">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#1E1E1E] text-[#f2b134] text-[11px] font-mono uppercase tracking-widest mb-6">
              ...
              <span>Water Inlet &amp; Fill Repair</span>
            </div>
            ...
            <h1 className="font-display font-extrabold text-4xl sm:text-5xl lg:text-[56px] leading-[1.05] tracking-tight text-neutral-900 mb-6">
              ...
              <span className="relative inline-block">
                <span className="relative z-10">Water Inlet Repair</span>
            ...
            <p className="text-neutral-600 text-[15px] sm:text-[17px] leading-relaxed max-w-xl mb-8">
              Machine not filling, filling too slowly or water won&apos;t stop? Our certified technicians fix every water inlet and fill fault — same day, with genuine OEM parts and a full service warranty.
            </p>
          ...
          <div className="relative">
            <div className="relative aspect-[4/3.4] w-full rounded-[2rem] overflow-hidden border border-neutral-200 shadow-2xl">
              <Image
                src="/Washing Machine Water Inlet Repair Hero Section.png"
                alt="washing machine water inlet repair in Dubai"
                fill
      ...
      <section className="w-full bg-white border-t border-b border-neutral-200/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-6">
            {[
              { value: '3,200+', label: 'Inlet repairs completed' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mb-14">
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl lg:text-[44px] tracking-tight text-neutral-900 leading-[1.1] mb-4">
              Signs You Need a Water Inlet Repair
            </h2>
            <p className="text-neutral-600 text-[15px] sm:text-base leading-relaxed">
              If your washing machine is not filling properly or showing a water supply error, the inlet valve or hose likely needs a professional fix.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="relative order-2 lg:order-1">
            <div className="relative aspect-square w-full rounded-[2rem] overflow-hidden border border-neutral-200 shadow-xl">
              <Image
                src="/What Causes Washing Machine Water Inlet Problems.png"
                alt="Technician checking washing machine water inlet"
                fill
          ...
          <div className="order-1 lg:order-2">
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl tracking-tight text-neutral-900 leading-[1.1] mb-6">
              What Causes Water Inlet Problems?
            </h2>
            <p className="text-neutral-600 text-[15px] sm:text-base leading-relaxed mb-8">
              A washing machine that won&apos;t fill or fills incorrectly usually comes down to a few common faults. Our technicians check each one carefully to find the real cause.
            </p>
          ...
          <div className="lg:hidden relative z-10 flex flex-col gap-6">
            ...
            <div className="flex items-start gap-4">
              <h2 className="font-display font-extrabold text-[26px] sm:text-4xl text-neutral-900 leading-[1.12] tracking-tight flex-1 mt-6 sm:mt-8">
                Machine not filling with water? <span className="text-[#c8901f]">We&apos;ll fix it today.</span>
              </h2>
            ...
            <p className="text-neutral-600 text-[15px] sm:text-base leading-relaxed">
              Book a same-day water inlet repair with Dubai&apos;s trusted technicians. Transparent pricing,
      ...
      <section className="w-full py-20 sm:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl lg:text-[44px] tracking-tight text-neutral-900 leading-[1.1] mb-4">
              Our Water Inlet Repair Process
            </h2>
            <p className="text-neutral-600 text-[15px] sm:text-base leading-relaxed">
              A clear, six-step process to get your washing machine filling properly again — no guesswork and no hidden costs.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-6">
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl lg:text-[44px] tracking-tight text-neutral-900 leading-[1.1] mb-6">
              A Complete Water Inlet Service
            </h2>
            <p className="text-neutral-600 text-[15px] sm:text-base leading-relaxed mb-10 max-w-lg">
              Every water inlet repair includes a full inspection of the valve, hose, filter and pressure switch — not just a quick look. Here is what your visit covers.
            </p>
          ...
          <div className="lg:col-span-6 relative">
            <div className="relative aspect-[4/3] w-full rounded-[2rem] overflow-hidden border border-neutral-200 shadow-2xl">
              <Image
                src="/Complete Washing Machine Water Inlet Repair Service.png"
                alt="Washing machine filling correctly after inlet repair"
                fill
                sizes="(max-width: 1024px) 100vw, 600px"
                className="object-cover"
              />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl lg:text-[44px] tracking-tight text-neutral-900 leading-[1.1]">
              Dubai&apos;s Water Inlet Repair Specialists
            </h2>
          </div>
      ...
      <section className="w-full bg-[#FAF9F5] border-t border-neutral-200/60 py-20 sm:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl lg:text-[44px] tracking-tight text-neutral-900 leading-[1.1] mb-6">
              Keep Water Flowing Into Your Machine
            </h2>
            <p className="text-neutral-600 text-[15px] sm:text-base leading-relaxed mb-8 max-w-lg">
              A few simple habits keep your washing machine water supply working smoothly and help you avoid fill problems.
            </p>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                { icon: <Filter className="h-5 w-5" />, title: 'Clean the Inlet Filter', desc: 'Unscrew the inlet hose every few months and clean the small mesh filter to stop sediment from blocking water flow.' },
                { icon: <Waves className="h-5 w-5" />, title: 'Check the Tap Is Fully Open', desc: 'A partly closed tap slows the fill. Make sure the tap behind the machine is turned on all the way.' },
                { icon: <Gauge className="h-5 w-5" />, title: 'Inspect the Hoses for Kinks', desc: 'A bent or squashed inlet hose reduces water pressure. Keep hoses straight and free from furniture.' },
                { icon: <Lock className="h-5 w-5" />, title: 'Replace Old Rubber Washers', desc: 'The small rubber washers inside the hose connectors wear out over time and start to leak. Swap them early.' },
              ].map((tip) => (
          ...
          <div className="relative">
            <div className="relative aspect-[4/5] w-full rounded-[2rem] overflow-hidden border border-neutral-200 shadow-2xl">
              <Image
                src="/Keep Water Flowing into Your Washing Machine.png"
                alt="Well-maintained washing machine water inlet"
                fill
                sizes="(max-width: 1024px) 100vw, 560px"
                className="object-cover"
              />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
          <div className="text-left max-w-3xl mb-12">
            <span className="text-[#f2b134] font-mono text-[11px] tracking-widest uppercase mb-3 block">
              WATER INLET DIAGNOSTIC &amp; REPAIR BENCHMARKS
            </span>
            <h2 className="font-display font-bold text-3xl sm:text-4xl text-neutral-900 tracking-tight leading-none mb-4">
              Water Inlet Fault &amp; Repair Matrix
            </h2>
            <p className="text-neutral-500 text-sm sm:text-base leading-relaxed font-sans">
              A clear breakdown of the most common water inlet faults we fix, the genuine OEM parts used, and how fast we get your machine filling again.
            </p>
          </div>
            ...
            <table className="w-full table-auto border-collapse text-left font-sans">
              <thead>
                <tr className="bg-neutral-50/75 border-b border-neutral-200/30 text-neutral-450 text-xs font-mono uppercase tracking-wider">
                  <th className="py-5 px-6 font-bold">Inlet Fault</th>
              ...
              <tbody className="text-sm text-neutral-650 divide-y divide-neutral-100">
                {[
                  { num: '01', name: 'Inlet Valve Failure', problem: 'Machine does not fill at all; solenoid valve stuck closed or burned out.', parts: 'OEM Water Inlet Valve Assembly', speed: 'Same Day', color: 'emerald', pulse: true },
                  { num: '02', name: 'Blocked Inlet Filter', problem: 'Very slow fill caused by sediment and debris clogging the mesh screen.', parts: 'Filter Clean-Out & Hose Flush', speed: 'Same Day', color: 'amber', pulse: false },
                  { num: '03', name: 'Inlet Hose Damage', problem: 'Kinked, cracked or leaking hose reducing water flow to the machine.', parts: 'Genuine Inlet Hose & Connector Set', speed: 'Same Day', color: 'blue', pulse: false },
                  { num: '04', name: 'Pressure Switch Fault', problem: 'Machine overfills or underfills because the water level sensor reads wrong.', parts: 'OEM Pressure Switch & Tube', speed: '24-48 Hours', color: 'violet', pulse: false },
                  { num: '05', name: 'Tap Connector Leak', problem: 'Water leaking from the hose connection at the wall tap or machine inlet.', parts: 'Tap Adaptor & Rubber Washer Replacement', speed: 'Same Day', color: 'neutral', pulse: false },
                ].map((row) => (
          ...
          <div className="md:hidden flex flex-col gap-4">
            {[
              { num: '01', name: 'Inlet Valve Failure', problem: 'Machine does not fill at all; solenoid valve stuck closed or burned out.', parts: 'OEM Water Inlet Valve Assembly', speed: 'Same Day', dotColor: 'bg-emerald-500', badgeBg: 'bg-emerald-50', badgeText: 'text-emerald-700', badgeBorder: 'border-emerald-100/50' },
              { num: '02', name: 'Blocked Inlet Filter', problem: 'Very slow fill caused by sediment and debris clogging the mesh screen.', parts: 'Filter Clean-Out & Hose Flush', speed: 'Same Day', dotColor: 'bg-amber-500', badgeBg: 'bg-amber-50', badgeText: 'text-amber-700', badgeBorder: 'border-amber-100/50' },
              { num: '03', name: 'Inlet Hose Damage', problem: 'Kinked, cracked or leaking hose reducing water flow to the machine.', parts: 'Genuine Inlet Hose & Connector Set', speed: 'Same Day', dotColor: 'bg-blue-500', badgeBg: 'bg-blue-50', badgeText: 'text-blue-700', badgeBorder: 'border-blue-100/50' },
              { num: '04', name: 'Pressure Switch Fault', problem: 'Machine overfills or underfills because the water level sensor reads wrong.', parts: 'OEM Pressure Switch & Tube', speed: '24-48 Hours', dotColor: 'bg-violet-400', badgeBg: 'bg-violet-50', badgeText: 'text-violet-700', badgeBorder: 'border-violet-100/50' },
              { num: '05', name: 'Tap Connector Leak', problem: 'Water leaking from the hose connection at the wall tap or machine inlet.', parts: 'Tap Adaptor & Rubber Washer Replacement', speed: 'Same Day', dotColor: 'bg-neutral-500', badgeBg: 'bg-neutral-100', badgeText: 'text-neutral-700', badgeBorder: 'border-neutral-200' },
            ].map((row) => (
      ...
      <section className="w-full bg-[#FAF9F5] pb-24 sm:pb-32 pt-20 sm:pt-28 border-t border-neutral-200/40">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-neutral-500 text-sm sm:text-base leading-relaxed font-sans">
              Get quick answers to common washing machine water inlet problems and expert repair guidance.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-5 flex flex-col gap-5 text-left">
              ...
              <p className="text-neutral-500 text-[15px] sm:text-base leading-relaxed font-sans max-w-md mt-2">
                Fill in the form and our team will get back to you within 30 minutes. Same-day washing machine water inlet repair available across all areas in Dubai.
              </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-10">
            ...
            <div className="flex flex-col gap-4">
              ...
              <ul className="flex flex-col gap-2.5 text-neutral-500 text-[13px]">
                <li className="text-[#f2b134]">Water Inlet Repair</li>
