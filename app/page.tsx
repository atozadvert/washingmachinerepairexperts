    ...
    <div className="min-h-screen bg-[#FAF9F5] text-neutral-900 selection:bg-[#f2b134]/30 flex flex-col font-sans">
        ...
        >
          ...
          <div className="flex items-center min-w-0">
            <div
              ...
              className="relative h-16 w-48 sm:h-20 sm:w-60 lg:h-24 lg:w-72 -my-4 sm:-my-6 flex items-center justify-start cursor-pointer selection:bg-transparent select-none z-10 shrink-0 transition-transform hover:scale-[1.02]"
            >
              <Image
            ...
            <nav className="hidden md:flex items-center gap-4 lg:gap-6 font-sans text-[15px] lg:text-[16px] font-medium text-neutral-300 whitespace-nowrap">
                ...
                <AnimatePresence>
                  {isPagesDropdownOpen && (
                    <motion.div
                      ...
                      className="absolute top-10 -left-40 w-[560px] bg-[#1E1E1E] border border-neutral-800 rounded-2xl shadow-2xl p-4 z-50 text-sm text-neutral-300 max-h-[75vh] overflow-y-auto"
                    >
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        {[
                          ...
                          <Link
                            ...
                            className="flex flex-col items-center text-center gap-2 px-3 py-3.5 rounded-xl hover:bg-neutral-800 transition-all group"
                          >
                            ...
                            <span className="text-[12px] font-medium text-neutral-300 group-hover:text-white transition-colors leading-tight">{service.title}</span>
                          </Link>
                        ))}
                      </div>
                    </motion.div>
              ...
              <div className="relative">
                <button
                  ...
                  className="transition-colors duration-200 hover:text-white flex items-center gap-1 cursor-pointer"
                >
                  Brands <ChevronDown className={`h-3.5 w-3.5 transition-transform duration-200 ${isBrandsDropdownOpen ? 'rotate-180' : ''}`} />
                </button>
                <AnimatePresence>
          ...
          <div className="flex items-center gap-3 md:gap-4 shrink-0 ml-2">
            ...
            <motion.button
              ...
              style={{ backgroundColor: '#f2b134' }}
              className="hidden md:flex rounded-full text-neutral-900 font-bold px-5 lg:px-6 py-2.5 items-center gap-2 text-sm shadow-lg hover:brightness-105 active:brightness-95 transition-all text-center selection:bg-transparent shrink-0"
                        ...
                        <div className="grid grid-cols-3 gap-1.5 pt-2 pb-3">
                          {[
                            ...
                            >
                              ...
                              <span className="text-[12px] font-medium leading-tight text-neutral-300 group-hover:text-white transition-colors">{service.title}</span>
                            </Link>
                          ))}
                        </div>
                      </motion.div>
      ...
      <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 select-none bg-neutral-50/50 border-t border-b border-neutral-200/30">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 mt-12">
          <a href="tel:+971557873590" className="rounded-full text-neutral-900 font-bold px-7 py-3.5 flex items-center gap-2.5 text-sm shadow-md transition-all hover:brightness-105" style={{ backgroundColor: '#f2b134' }}>
            <Phone className="h-4.5 w-4.5 stroke-[2.5]" /> Book A Repair
          </a>
          <a href="https://wa.me/971557873590" target="_blank" rel="noopener noreferrer" className="rounded-full bg-white text-neutral-900 font-bold px-7 py-3.5 flex items-center gap-2.5 text-sm shadow-sm border border-neutral-200 hover:bg-neutral-50 transition-colors">
