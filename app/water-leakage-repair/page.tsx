...
const NAV_SERVICES = [
  ...
  { title: 'Water Leakage Repair', icon: <ShieldCheck className="h-4 w-4" />, href: '/water-leakage-repair', active: true },
...
const SYMPTOMS = [
  {
    ...
    title: 'Water Pooling Under the Machine',
    desc: 'Puddles appearing around the base of your washing machine after or during a wash cycle.',
  },
  {
    icon: <Filter className="h-5 w-5" />,
    title: 'Leaking from the Door',
    desc: 'Water seeping past the door seal during wash or rinse phase, dripping onto the floor.',
  },
  {
    icon: <Droplets className="h-5 w-5" />,
    title: 'Dripping from Inlet Hoses',
    desc: 'Visible drips at the back of the machine where the water supply hoses connect.',
  },
  {
    icon: <AlertTriangle className="h-5 w-5" />,
    title: 'Damp or Mouldy Door Seal',
    desc: 'The rubber gasket around the door feels constantly wet, shows mould or has visible tears.',
  },
  {
    icon: <Gauge className="h-5 w-5" />,
    title: 'Water Marks on Surrounding Floors',
    desc: 'Intermittent leaks leaving stains, dampness or swelling on nearby flooring or cabinetry.',
  },
  {
    icon: <RotateCw className="h-5 w-5" />,
    title: 'Detergent Drawer Overflowing',
    desc: 'Water backs up and overflows through the soap dispenser drawer during the fill phase.',
  },
];

const CAUSES = [
  'Torn, cracked or worn door gasket / boot seal',
  'Loose or damaged water inlet hose connections',
  'Cracked or perforated outer tub',
  'Faulty water inlet valve not closing fully',
  'Blocked or overflowing detergent dispenser tray',
  'Damaged drain hose causing rear leakage',
];
...
const PROCESS = [
  {
    ...
    desc: 'Call or message us and we confirm a same-day slot for your water leakage repair anywhere in Dubai.',
  },
  {
    icon: <Truck className="h-5 w-5" />,
    title: 'Technician Dispatch',
    desc: 'A certified leakage specialist arrives at your door fully equipped with seals, hoses and valves.',
  },
  {
    icon: <Search className="h-5 w-5" />,
    title: 'On-Site Diagnosis',
    desc: 'We inspect the door seal, hoses, tub and inlet valve to pinpoint the exact source — then share a transparent quote.',
  },
  {
    icon: <Wrench className="h-5 w-5" />,
    title: 'Professional Repair',
    desc: 'The fault is fixed using genuine OEM parts: replacing seals, tightening connections or restoring watertight integrity.',
  },
  {
    icon: <ClipboardCheck className="h-5 w-5" />,
    title: 'Full Cycle Test',
    desc: 'We run a complete wash and rinse cycle to confirm zero leaks before we finish.',
  },
  {
    icon: <BadgeCheck className="h-5 w-5" />,
    title: 'Service Warranty',
    desc: 'Every water leakage repair is backed by a written warranty covering both parts and labour.',
  },
];

const INCLUDED = [
  'Full door seal / gasket inspection & replacement',
  'Water inlet hose pressure test',
  'Outer tub crack & leak detection',
  'Inlet valve flow test & replacement',
  'Detergent dispenser channel flush',
  'Complete leak-free verification cycle',
];
...
const WHY = [
  {
    ...
    desc: 'Most water leakage faults are diagnosed and fixed within a single visit across all Dubai areas.',
  },
  {
    icon: <ShieldCheck className="h-6 w-6" />,
    title: 'Genuine OEM Parts',
    desc: 'We fit only original manufacturer seals, hoses and valves for repairs that genuinely last.',
  },
  {
...
const FAQS = [
  {
    q: 'How much does a washing machine water leakage repair cost in Dubai?',
    a: 'A standard water leakage repair starts from an affordable call-out and diagnosis fee. Once our technician identifies the exact source on-site, you receive a transparent fixed quote before any work begins — so you always approve the price first.',
  },
  {
    q: 'Can you fix the water leak on the same day?',
    a: 'Yes. The majority of leakage faults — worn door seals, loose hoses and faulty valves — are resolved in a single same-day visit anywhere in Dubai, as our vans carry common parts in stock.',
  },
  {
  ...
  {
    q: 'Do you provide a warranty on leakage repairs?',
    a: 'Absolutely. Every water leakage repair comes with a written service warranty covering both the replaced parts and the labour, giving you complete peace of mind.',
  },
  {
    q: 'Is it safe to keep using my machine if it’s leaking?',
    a: 'We recommend stopping use immediately. A leaking machine can damage your flooring, cause electrical hazards and lead to mould growth — a quick repair prevents bigger problems and costs.',
  },
];
...
export default function WaterLeakageRepairPage() {
    ...
    <div className="min-h-screen bg-[#FAF9F5] text-neutral-900 flex flex-col font-sans selection:bg-[#f2b134]/30">
      ...
      <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 sm:pt-16 pb-12 sm:pb-20">
        ...
        <nav className="flex items-center gap-2 text-[13px] text-neutral-500 mb-8 sm:mb-12 font-medium">
          ...
          <ChevronRight className="h-3.5 w-3.5" />
          <span className="text-[#c8901f]">Water Leakage Repair</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          <div className="flex flex-col items-start">
            ...
            <h1 className="font-display font-extrabold text-4xl sm:text-5xl lg:text-[56px] leading-[1.05] tracking-tight text-neutral-900 mb-6">
              ...
              <span className="relative inline-block">
                <span className="relative z-10">Water Leakage Repair</span>
            ...
            <p className="text-neutral-600 text-[15px] sm:text-[17px] leading-relaxed max-w-xl mb-8">
              Water pooling under your machine, door seal leaking or hoses dripping? Our certified technicians
              diagnose and fix every water leakage fault — same day, with genuine OEM parts and
          ...
          <div className="relative">
            <div className="relative aspect-[4/3.4] w-full rounded-[2rem] overflow-hidden border border-neutral-200 shadow-2xl">
              <Image
                src="/Washing Machine Water Leakage Repair Hero Section.png"
                alt="Washing machine water leakage repair in Dubai"
                fill
      ...
      <section className="w-full bg-white border-t border-b border-neutral-200/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-6">
            {[
              { value: '4,000+', label: 'Leakage repairs completed' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mb-14">
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl lg:text-[44px] tracking-tight text-neutral-900 leading-[1.1] mb-4">
              Signs You Need a Water Leakage Repair
            </h2>
            <p className="text-neutral-600 text-[15px] sm:text-base leading-relaxed">
              If your washing machine shows any of these symptoms, there&apos;s likely a seal, hose or valve issue that needs
              professional attention. Catching leaks early prevents water damage to your home.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="relative order-2 lg:order-1">
            <div className="relative aspect-square w-full rounded-[2rem] overflow-hidden border border-neutral-200 shadow-xl">
              <Image
                src="/What Causes Washing Machine Water Leaks.png"
                alt="Technician inspecting washing machine for leaks"
                fill
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-neutral-600 text-[15px] sm:text-base leading-relaxed mb-8">
              A washing machine that leaks almost always traces back to one of a handful of
              culprits. Our technicians check each one methodically to find the real source — not just
              the symptom.
            </p>
          ...
          <div className="lg:hidden relative z-10 flex flex-col gap-6">
            ...
            <div className="flex items-start gap-4">
              <h2 className="font-display font-extrabold text-[26px] sm:text-4xl text-neutral-900 leading-[1.12] tracking-tight flex-1 mt-6 sm:mt-8">
                Washing machine leaking? <span className="text-[#c8901f]">We&apos;ll fix it today.</span>
              </h2>
            ...
            <p className="text-neutral-600 text-[15px] sm:text-base leading-relaxed">
              Book a same-day water leakage repair with Dubai&apos;s trusted technicians. Transparent pricing,
      ...
      <section className="w-full py-20 sm:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl lg:text-[44px] tracking-tight text-neutral-900 leading-[1.1] mb-4">
              Our Water Leakage Repair Process
            </h2>
            <p className="text-neutral-600 text-[15px] sm:text-base leading-relaxed">
              A clear, six-step process designed to stop your washing machine leaking and restore watertight performance —
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-6">
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl lg:text-[44px] tracking-tight text-neutral-900 leading-[1.1] mb-6">
              A Complete Leakage Service
            </h2>
            <p className="text-neutral-600 text-[15px] sm:text-base leading-relaxed mb-10 max-w-lg">
              Every water leakage repair booking includes a full inspection of the entire water system — not
          ...
          <div className="lg:col-span-6 relative">
            <div className="relative aspect-[4/3] w-full rounded-[2rem] overflow-hidden border border-neutral-200 shadow-2xl">
              <Image
                src="/Complete Washing Machine Water Leakage Repair Service.png"
                alt="Washing machine working perfectly after leakage repair"
                fill
                sizes="(max-width: 1024px) 100vw, 600px"
                className="object-cover"
              />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl lg:text-[44px] tracking-tight text-neutral-900 leading-[1.1]">
              Dubai&apos;s Water Leakage Repair Specialists
            </h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            ...
            <p className="text-neutral-600 text-[15px] sm:text-base leading-relaxed mb-8 max-w-lg">
              A few simple habits keep your washing machine watertight between professional
              visits — and help you spot trouble before it becomes costly water damage.
            </p>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                { icon: <Filter className="h-5 w-5" />, title: 'Inspect Door Seal Monthly', desc: 'Check the rubber gasket for tears, debris and mould — clean it regularly to maintain a tight seal.' },
                { icon: <Waves className="h-5 w-5" />, title: 'Check Hose Connections', desc: 'Tighten inlet and drain hose fittings every few months and look for signs of cracking or wear.' },
                { icon: <Droplets className="h-5 w-5" />, title: 'Use Correct Detergent Amount', desc: 'Excess detergent causes overflow and residue build-up that can lead to dispenser leaks.' },
                { icon: <Gauge className="h-5 w-5" />, title: 'Watch for Damp Spots', desc: 'Regularly check around and behind your machine for moisture — catching small leaks early prevents major damage.' },
              ].map((tip) => (
          ...
          <div className="relative">
            <div className="relative aspect-[4/5] w-full rounded-[2rem] overflow-hidden border border-neutral-200 shadow-2xl">
              <Image
                src="/Stop Washing Machine Water Leaks Fast.png"
                alt="Well-maintained washing machine in Dubai"
                fill
                sizes="(max-width: 1024px) 100vw, 560px"
                className="object-cover"
              />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
          <div className="text-left max-w-3xl mb-12">
            <span className="text-[#f2b134] font-mono text-[11px] tracking-widest uppercase mb-3 block">
              WATER LEAKAGE DIAGNOSTIC &amp; REPAIR BENCHMARKS
            </span>
            <h2 className="font-display font-bold text-3xl sm:text-4xl text-neutral-900 tracking-tight leading-none mb-4">
              Leakage Fault &amp; Repair Matrix
            </h2>
            <p className="text-neutral-500 text-sm sm:text-base leading-relaxed font-sans">
              A clear breakdown of the most common water leakage faults we resolve, the genuine OEM parts
              involved, and realistic speed benchmarks for making your machine leak-free again.
            </p>
          </div>
            ...
            <table className="w-full table-auto border-collapse text-left font-sans">
              <thead>
                <tr className="bg-neutral-50/75 border-b border-neutral-200/30 text-neutral-450 text-xs font-mono uppercase tracking-wider">
                  <th className="py-5 px-6 font-bold">Leakage Fault</th>
              ...
              <tbody className="text-sm text-neutral-650 divide-y divide-neutral-100">
                {[
                  { num: '01', name: 'Door Seal Leak', problem: 'Water seeps past a torn, worn or misaligned rubber door gasket during every wash.', parts: 'OEM Door Gasket / Boot Seal Replacement', speed: 'Same Day', color: 'emerald', pulse: true },
                  { num: '02', name: 'Inlet Hose Failure', problem: 'Dripping or spraying from rear hose connections due to cracks, loose fittings or perished rubber.', parts: 'Braided Steel Inlet Hose & Washer Kit', speed: 'Same Day', color: 'amber', pulse: false },
                  { num: '03', name: 'Tub Crack / Perforation', problem: 'Hairline crack in the outer tub causing slow leaks that pool underneath the machine.', parts: 'Outer Tub Sealant Repair or Assembly Replacement', speed: '24-48 Hours', color: 'blue', pulse: false },
                  { num: '04', name: 'Inlet Valve Fault', problem: 'Valve fails to close fully, allowing water to trickle in continuously even when off.', parts: 'OEM Water Inlet Valve Replacement & Flow Test', speed: 'Same Day', color: 'violet', pulse: false },
                  { num: '05', name: 'Dispenser Overflow', problem: 'Blocked dispenser channels cause water to back up and overflow from the detergent drawer.', parts: 'Dispenser Channel Flush & Seal Replacement', speed: 'Same Day', color: 'neutral', pulse: false },
                ].map((row) => (
          ...
          <div className="md:hidden flex flex-col gap-4">
            {[
              { num: '01', name: 'Door Seal Leak', problem: 'Water seeps past a torn, worn or misaligned rubber door gasket during every wash.', parts: 'OEM Door Gasket / Boot Seal Replacement', speed: 'Same Day', dotColor: 'bg-emerald-500', badgeBg: 'bg-emerald-50', badgeText: 'text-emerald-700', badgeBorder: 'border-emerald-100/50' },
              { num: '02', name: 'Inlet Hose Failure', problem: 'Dripping or spraying from rear hose connections due to cracks, loose fittings or perished rubber.', parts: 'Braided Steel Inlet Hose & Washer Kit', speed: 'Same Day', dotColor: 'bg-amber-500', badgeBg: 'bg-amber-50', badgeText: 'text-amber-700', badgeBorder: 'border-amber-100/50' },
              { num: '03', name: 'Tub Crack / Perforation', problem: 'Hairline crack in the outer tub causing slow leaks that pool underneath the machine.', parts: 'Outer Tub Sealant Repair or Assembly Replacement', speed: '24-48 Hours', dotColor: 'bg-blue-500', badgeBg: 'bg-blue-50', badgeText: 'text-blue-700', badgeBorder: 'border-blue-100/50' },
              { num: '04', name: 'Inlet Valve Fault', problem: 'Valve fails to close fully, allowing water to trickle in continuously even when off.', parts: 'OEM Water Inlet Valve Replacement & Flow Test', speed: 'Same Day', dotColor: 'bg-violet-400', badgeBg: 'bg-violet-50', badgeText: 'text-violet-700', badgeBorder: 'border-violet-100/50' },
              { num: '05', name: 'Dispenser Overflow', problem: 'Blocked dispenser channels cause water to back up and overflow from the detergent drawer.', parts: 'Dispenser Channel Flush & Seal Replacement', speed: 'Same Day', dotColor: 'bg-neutral-500', badgeBg: 'bg-neutral-100', badgeText: 'text-neutral-700', badgeBorder: 'border-neutral-200' },
            ].map((row) => (
      ...
      <section className="w-full bg-[#FAF9F5] pb-24 sm:pb-32 pt-20 sm:pt-28 border-t border-neutral-200/40">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-neutral-500 text-sm sm:text-base leading-relaxed font-sans">
              Get immediate professional answers to common washing machine water leakage issues and quick diagnostic guidance.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-5 flex flex-col gap-5 text-left">
              ...
              <p className="text-neutral-500 text-[15px] sm:text-base leading-relaxed font-sans max-w-md mt-2">
                Fill in the form and our team will get back to you within 30 minutes. Same-day washing machine water leakage repair available across all areas in Dubai.
              </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-10">
            ...
            <div className="flex flex-col gap-4">
              ...
              <ul className="flex flex-col gap-2.5 text-neutral-500 text-[13px]">
                ...
                <li className="text-[#f2b134]">Water Leakage Repair</li>
