...
const NAV_SERVICES = [
  ...
  { title: 'Power Fault Repair', icon: <Zap className="h-4 w-4" />, href: '/power-fault-repair', active: true },
...
const SYMPTOMS = [
  {
    ...
    title: 'Machine Won\'t Turn On',
    desc: 'You press the power button but nothing happens. No lights, no sounds — the machine is completely dead.',
  },
  {
    icon: <AlertTriangle className="h-5 w-5" />,
    title: 'Power Cuts Out Mid-Cycle',
    desc: 'The machine starts a wash but shuts off part way through. A tripping fuse or faulty board may be the cause.',
  },
  {
    icon: <Gauge className="h-5 w-5" />,
    title: 'Lights Flicker on the Display',
    desc: 'The display lights blink, flash or go dim. This usually points to a loose connection or a failing control board.',
  },
  {
    icon: <Filter className="h-5 w-5" />,
    title: 'Tripping the Home Fuse Box',
    desc: 'The washing machine trips your circuit breaker every time you turn it on. A short circuit or faulty heating element is likely.',
  },
  {
    icon: <Waves className="h-5 w-5" />,
    title: 'Burning Smell from the Machine',
    desc: 'A burning or electrical smell coming from the machine means something is overheating. Stop using it and call for help right away.',
  },
  {
    icon: <RotateCw className="h-5 w-5" />,
    title: 'Buttons Not Responding',
    desc: 'You press buttons but the machine does not react. The control panel or wiring behind it may have a fault.',
  },
];

const CAUSES = [
  'Blown thermal fuse or tripped internal safety switch',
  'Faulty main control board or damaged PCB',
  'Broken power cord or loose plug connection',
  'Short circuit in the heating element or motor winding',
  'Damaged door interlock preventing the power circuit from completing',
  'Corroded wiring or burnt connector terminals inside the machine',
];
...
const PROCESS = [
  {
    ...
    desc: 'Call or message us and we book a same-day slot for your power fault repair anywhere in Dubai.',
  },
  {
    icon: <Truck className="h-5 w-5" />,
    title: 'Technician Dispatch',
    desc: 'A certified technician arrives with testing equipment, fuses, boards and wiring parts ready.',
  },
  {
    icon: <Search className="h-5 w-5" />,
    title: 'On-Site Diagnosis',
    desc: 'We test the power supply, wiring, control board and safety switches to find the exact fault — then share a clear quote.',
  },
  {
    icon: <Wrench className="h-5 w-5" />,
    title: 'Professional Repair',
    desc: 'The faulty part is replaced using genuine OEM components so your machine powers on safely again.',
  },
  {
    icon: <ClipboardCheck className="h-5 w-5" />,
    title: 'Full Cycle Test',
    desc: 'We run a full wash cycle to confirm the machine powers on, stays on and completes without tripping.',
  },
  {
    icon: <BadgeCheck className="h-5 w-5" />,
    title: 'Service Warranty',
    desc: 'Every power fault repair is backed by a written warranty covering both parts and labour.',
  },
];

const INCLUDED = [
  'Full power supply and voltage test',
  'Control board and PCB inspection',
  'Thermal fuse and safety switch check',
  'Power cord and plug connection test',
  'Heating element resistance test',
  'Full wash cycle power stability check',
];
...
const WHY = [
  {
    ...
    desc: 'Most power faults are diagnosed and fixed within a single visit across all Dubai areas.',
  },
  {
...
const FAQS = [
  {
    q: 'How much does a washing machine power fault repair cost in Dubai?',
  ...
  {
    q: 'Can you fix a dead washing machine on the same day?',
    a: 'Yes. Most power faults including blown fuses, faulty boards and wiring problems are fixed in a single same-day visit across Dubai.',
  },
  {
    q: 'Why does my washing machine keep tripping the fuse box?',
    a: 'A tripping breaker usually means there is a short circuit inside the machine. It could be in the heating element, motor or wiring. Our technician will test and find the exact cause.',
  },
  {
    q: 'Is it dangerous to use a machine with a power fault?',
    a: 'Yes. Electrical faults can cause shocks or fire. We recommend switching the machine off at the wall and calling us for a same-day inspection.',
  },
  {
    q: 'Do you provide a warranty on power fault repairs?',
    a: 'Yes. Every repair comes with a written warranty covering both the new parts and the labour.',
  },
];

export default function PowerFaultRepairPage() {
    ...
    <div className="min-h-screen bg-[#FAF9F5] text-neutral-900 flex flex-col font-sans selection:bg-[#f2b134]/30">
      ...
      <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 sm:pt-16 pb-12 sm:pb-20">
        ...
        <nav className="flex items-center gap-2 text-[13px] text-neutral-500 mb-8 sm:mb-12 font-medium">
          ...
          <ChevronRight className="h-3.5 w-3.5" />
          <span className="text-[#c8901f]">Power Fault Repair</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          <div className="flex flex-col items-start">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#1E1E1E] text-[#f2b134] text-[11px] font-mono uppercase tracking-widest mb-6">
              ...
              <span>Power &amp; Electrical Repair</span>
            </div>
            ...
            <h1 className="font-display font-extrabold text-4xl sm:text-5xl lg:text-[56px] leading-[1.05] tracking-tight text-neutral-900 mb-6">
              ...
              <span className="relative inline-block">
                <span className="relative z-10">Power Fault Repair</span>
            ...
            <p className="text-neutral-600 text-[15px] sm:text-[17px] leading-relaxed max-w-xl mb-8">
              Machine won&apos;t turn on, cuts out mid-cycle or keeps tripping the fuse? Our certified technicians find and fix every power and electrical fault — same day, with genuine OEM parts and a full service warranty.
            </p>
          ...
          <div className="relative">
            <div className="relative aspect-[4/3.4] w-full rounded-[2rem] overflow-hidden border border-neutral-200 shadow-2xl">
              <Image
                src="/Washing Machine Power Fault Repair Hero Section.png"
                alt="washing machine power fault repair in Dubai"
                fill
            ...
            >
              ...
              <div>
                <p className="text-2xl font-extrabold font-display text-neutral-900 leading-none">~70 min</p>
      ...
      <section className="w-full bg-white border-t border-b border-neutral-200/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-6">
            {[
              { value: '3,800+', label: 'Power fault repairs completed' },
              { value: '20+', label: 'Brands serviced' },
              { value: '70 min', label: 'Average fix time' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mb-14">
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl lg:text-[44px] tracking-tight text-neutral-900 leading-[1.1] mb-4">
              Signs You Need a Power Fault Repair
            </h2>
            <p className="text-neutral-600 text-[15px] sm:text-base leading-relaxed">
              If your washing machine shows any of these electrical symptoms, it needs a professional check. Ignoring power faults can be dangerous.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="relative order-2 lg:order-1">
            <div className="relative aspect-square w-full rounded-[2rem] overflow-hidden border border-neutral-200 shadow-xl">
              <Image
                src="/What Causes Washing Machine Power Faults.png"
                alt="Technician testing washing machine power fault"
                fill
          ...
          <div className="order-1 lg:order-2">
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl tracking-tight text-neutral-900 leading-[1.1] mb-6">
              What Causes Power Faults?
            </h2>
            <p className="text-neutral-600 text-[15px] sm:text-base leading-relaxed mb-8">
              A washing machine that won&apos;t power on or keeps cutting out usually comes down to a few electrical faults. Our technicians test each one safely and find the real cause.
            </p>
          ...
          <div className="lg:hidden relative z-10 flex flex-col gap-6">
            ...
            <div className="flex items-start gap-4">
              <h2 className="font-display font-extrabold text-[26px] sm:text-4xl text-neutral-900 leading-[1.12] tracking-tight flex-1 mt-6 sm:mt-8">
                Machine won&apos;t power on? <span className="text-[#c8901f]">We&apos;ll fix it today.</span>
              </h2>
            ...
            <p className="text-neutral-600 text-[15px] sm:text-base leading-relaxed">
              Book a same-day power fault repair with Dubai&apos;s trusted technicians. Transparent pricing,
      ...
      <section className="w-full py-20 sm:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl lg:text-[44px] tracking-tight text-neutral-900 leading-[1.1] mb-4">
              Our Power Fault Repair Process
            </h2>
            <p className="text-neutral-600 text-[15px] sm:text-base leading-relaxed">
              A clear, six-step process to safely diagnose and fix your washing machine power fault — no guesswork and no hidden costs.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-6">
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl lg:text-[44px] tracking-tight text-neutral-900 leading-[1.1] mb-6">
              A Complete Power Fault Service
            </h2>
            <p className="text-neutral-600 text-[15px] sm:text-base leading-relaxed mb-10 max-w-lg">
              Every power fault repair includes a full electrical inspection of the machine — not just a quick check. Here is what your visit covers.
            </p>
          ...
          <div className="lg:col-span-6 relative">
            <div className="relative aspect-[4/3] w-full rounded-[2rem] overflow-hidden border border-neutral-200 shadow-2xl">
              <Image
                src="/Complete Washing Machine Power Fault Repair Service.png"
                alt="Washing machine powered on after electrical repair"
                fill
                sizes="(max-width: 1024px) 100vw, 600px"
                className="object-cover"
              />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl lg:text-[44px] tracking-tight text-neutral-900 leading-[1.1]">
              Dubai&apos;s Power Fault Repair Specialists
            </h2>
          </div>
      ...
      <section className="w-full bg-[#FAF9F5] border-t border-neutral-200/60 py-20 sm:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl lg:text-[44px] tracking-tight text-neutral-900 leading-[1.1] mb-6">
              Keep Your Machine Powered Safely
            </h2>
            <p className="text-neutral-600 text-[15px] sm:text-base leading-relaxed mb-8 max-w-lg">
              A few simple habits protect your washing machine from electrical problems and help you spot faults early.
            </p>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                { icon: <Zap className="h-5 w-5" />, title: 'Use a Surge Protector', desc: 'A power surge can damage the control board. A simple surge protector at the plug keeps your machine safe.' },
                { icon: <Filter className="h-5 w-5" />, title: 'Check the Power Cord', desc: 'Look for frayed wires, loose plugs or burn marks on the cord. Replace damaged cords before they cause a short.' },
                { icon: <Waves className="h-5 w-5" />, title: 'Don\'t Use Extension Leads', desc: 'Washing machines draw a lot of power. Always plug directly into a wall socket to avoid overheating.' },
                { icon: <Gauge className="h-5 w-5" />, title: 'Watch for Warning Signs', desc: 'Flickering lights, burning smells or a tripping fuse box are signs to stop and call a technician.' },
              ].map((tip) => (
          ...
          <div className="relative">
            <div className="relative aspect-[4/5] w-full rounded-[2rem] overflow-hidden border border-neutral-200 shadow-2xl">
              <Image
                src="/Restore Power to Your Washing Machine.png"
                alt="Safely powered washing machine in Dubai"
                fill
                sizes="(max-width: 1024px) 100vw, 560px"
                className="object-cover"
              />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
          <div className="text-left max-w-3xl mb-12">
            <span className="text-[#f2b134] font-mono text-[11px] tracking-widest uppercase mb-3 block">
              POWER FAULT DIAGNOSTIC &amp; REPAIR BENCHMARKS
            </span>
            <h2 className="font-display font-bold text-3xl sm:text-4xl text-neutral-900 tracking-tight leading-none mb-4">
              Power Fault &amp; Repair Matrix
            </h2>
            <p className="text-neutral-500 text-sm sm:text-base leading-relaxed font-sans">
              A clear breakdown of the most common power faults we fix, the genuine OEM parts used, and how fast we get your machine running again.
            </p>
          </div>
            ...
            <table className="w-full table-auto border-collapse text-left font-sans">
              <thead>
                <tr className="bg-neutral-50/75 border-b border-neutral-200/30 text-neutral-450 text-xs font-mono uppercase tracking-wider">
                  <th className="py-5 px-6 font-bold">Power Fault</th>
              ...
              <tbody className="text-sm text-neutral-650 divide-y divide-neutral-100">
                {[
                  { num: '01', name: 'Dead Machine (No Power)', problem: 'Machine completely unresponsive; no lights, display or sounds when powered on.', parts: 'OEM Thermal Fuse & Power Supply Module', speed: 'Same Day', color: 'emerald', pulse: true },
                  { num: '02', name: 'Tripping Circuit Breaker', problem: 'Machine trips the home fuse box as soon as it is switched on.', parts: 'Heating Element Test & Short Circuit Repair', speed: 'Same Day', color: 'amber', pulse: false },
                  { num: '03', name: 'Control Board Failure', problem: 'Display is dead or shows random errors; board not sending commands.', parts: 'OEM Main PCB & Control Board', speed: '24-48 Hours', color: 'blue', pulse: false },
                  { num: '04', name: 'Mid-Cycle Power Cut', problem: 'Machine starts but shuts off during wash, rinse or spin cycle.', parts: 'Safety Switch Reset & Wiring Repair', speed: 'Same Day', color: 'violet', pulse: false },
                  { num: '05', name: 'Faulty Power Cord', problem: 'Frayed, burnt or loose cable stopping power from reaching the machine.', parts: 'Genuine Power Cord & Terminal Block', speed: 'Same Day', color: 'neutral', pulse: false },
                ].map((row) => (
          ...
          <div className="md:hidden flex flex-col gap-4">
            {[
              { num: '01', name: 'Dead Machine (No Power)', problem: 'Machine completely unresponsive; no lights, display or sounds when powered on.', parts: 'OEM Thermal Fuse & Power Supply Module', speed: 'Same Day', dotColor: 'bg-emerald-500', badgeBg: 'bg-emerald-50', badgeText: 'text-emerald-700', badgeBorder: 'border-emerald-100/50' },
              { num: '02', name: 'Tripping Circuit Breaker', problem: 'Machine trips the home fuse box as soon as it is switched on.', parts: 'Heating Element Test & Short Circuit Repair', speed: 'Same Day', dotColor: 'bg-amber-500', badgeBg: 'bg-amber-50', badgeText: 'text-amber-700', badgeBorder: 'border-amber-100/50' },
              { num: '03', name: 'Control Board Failure', problem: 'Display is dead or shows random errors; board not sending commands.', parts: 'OEM Main PCB & Control Board', speed: '24-48 Hours', dotColor: 'bg-blue-500', badgeBg: 'bg-blue-50', badgeText: 'text-blue-700', badgeBorder: 'border-blue-100/50' },
              { num: '04', name: 'Mid-Cycle Power Cut', problem: 'Machine starts but shuts off during wash, rinse or spin cycle.', parts: 'Safety Switch Reset & Wiring Repair', speed: 'Same Day', dotColor: 'bg-violet-400', badgeBg: 'bg-violet-50', badgeText: 'text-violet-700', badgeBorder: 'border-violet-100/50' },
              { num: '05', name: 'Faulty Power Cord', problem: 'Frayed, burnt or loose cable stopping power from reaching the machine.', parts: 'Genuine Power Cord & Terminal Block', speed: 'Same Day', dotColor: 'bg-neutral-500', badgeBg: 'bg-neutral-100', badgeText: 'text-neutral-700', badgeBorder: 'border-neutral-200' },
            ].map((row) => (
      ...
      <section className="w-full bg-[#FAF9F5] pb-24 sm:pb-32 pt-20 sm:pt-28 border-t border-neutral-200/40">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-neutral-500 text-sm sm:text-base leading-relaxed font-sans">
              Get quick answers to common washing machine power fault problems and expert repair guidance.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-5 flex flex-col gap-5 text-left">
              ...
              <p className="text-neutral-500 text-[15px] sm:text-base leading-relaxed font-sans max-w-md mt-2">
                Fill in the form and our team will get back to you within 30 minutes. Same-day washing machine power fault repair available across all areas in Dubai.
              </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-10">
            ...
            <div className="flex flex-col gap-4">
              ...
              <ul className="flex flex-col gap-2.5 text-neutral-500 text-[13px]">
                <li className="text-[#f2b134]">Power Fault Repair</li>
