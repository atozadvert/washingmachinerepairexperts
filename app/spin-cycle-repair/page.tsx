...
const NAV_SERVICES = [
  ...
  { title: 'Spin Cycle Repair', icon: <RotateCw className="h-4 w-4" />, href: '/spin-cycle-repair', active: true },
...
const SYMPTOMS = [
  {
    ...
    title: "Drum Won't Spin At All",
    desc: 'The wash cycle completes but the drum never enters the spin phase, leaving clothes soaking wet.',
  },
  {
    icon: <Gauge className="h-5 w-5" />,
    title: 'Slow or Weak Spin Speed',
    desc: 'The drum rotates but at reduced RPM, so laundry comes out much wetter than it should.',
  },
  {
    icon: <Waves className="h-5 w-5" />,
    title: 'Excessive Vibration During Spin',
    desc: 'The machine shakes violently, walks across the floor or bangs against surrounding surfaces.',
  },
  {
    icon: <AlertTriangle className="h-5 w-5" />,
    title: 'Loud Grinding or Squealing',
    desc: 'Metallic grinding, squealing belts or rumbling noises that intensify at high spin speeds.',
  },
  {
    icon: <Filter className="h-5 w-5" />,
    title: 'Error Codes on Display',
    desc: 'Spin-related fault codes (UE, UB, E4, F7) halt the cycle and prevent proper spinning.',
  },
  {
    icon: <Droplets className="h-5 w-5" />,
    title: 'Clothes Still Soaking Wet',
    desc: "Laundry comes out dripping after a full cycle — a clear sign the spin phase isn't working properly.",
  },
];

const CAUSES = [
  'Worn or snapped drive belt no longer transferring motor power',
  'Faulty motor carbon brushes too short to make proper contact',
  'Defective motor control board sending incorrect spin signals',
  'Unbalanced load or failed suspension springs causing safety cut-out',
  'Worn drum bearings creating excessive friction at high speed',
  'Faulty lid switch or door lock sensor preventing spin activation',
];
...
const PROCESS = [
  {
    ...
    desc: 'Call or message us and we confirm a same-day slot for your spin cycle repair anywhere in Dubai.',
  },
  {
    icon: <Truck className="h-5 w-5" />,
    title: 'Technician Dispatch',
    desc: 'A certified spin cycle specialist arrives at your door fully equipped with belts, brushes and motor parts.',
  },
  {
    icon: <Search className="h-5 w-5" />,
    title: 'On-Site Diagnosis',
    desc: 'We inspect the belt, motor, bearings and sensors to pinpoint the exact cause — then share a transparent quote.',
  },
  {
    icon: <Wrench className="h-5 w-5" />,
    title: 'Professional Repair',
    desc: 'The fault is fixed using genuine OEM parts: replacing belts, brushes or restoring full spin performance.',
  },
  {
    icon: <ClipboardCheck className="h-5 w-5" />,
    title: 'Full Cycle Test',
    desc: 'We run a complete spin test at all speeds to confirm the drum rotates smoothly before we finish.',
  },
  {
    icon: <BadgeCheck className="h-5 w-5" />,
    title: 'Service Warranty',
    desc: 'Every spin cycle repair is backed by a written warranty covering both parts and labour.',
  },
];

const INCLUDED = [
  'Complete drive belt inspection & replacement',
  'Motor carbon brush test & swap',
  'Drum bearing condition assessment',
  'Suspension spring & damper check',
  'Motor control board diagnostic',
  'Full spin speed verification cycle',
];
...
const WHY = [
  {
    ...
    desc: 'Most spin cycle faults are diagnosed and fixed within a single visit across all Dubai areas.',
  },
  {
    icon: <ShieldCheck className="h-6 w-6" />,
    title: 'Genuine OEM Parts',
    desc: 'We fit only original manufacturer belts, brushes and motor parts for repairs that genuinely last.',
  },
  {
...
const FAQS = [
  {
    q: 'How much does a washing machine spin cycle repair cost in Dubai?',
    a: 'A standard spin cycle repair starts from an affordable call-out and diagnosis fee. Once our technician identifies the exact cause on-site, you receive a transparent fixed quote before any work begins — so you always approve the price first.',
  },
  {
    q: 'Can you fix the spin cycle problem on the same day?',
    a: 'Yes. The majority of spin cycle faults — worn belts, faulty brushes and motor issues — are resolved in a single same-day visit anywhere in Dubai, as our vans carry common parts in stock.',
  },
  {
  ...
  {
    q: 'Do you provide a warranty on spin cycle repairs?',
    a: 'Absolutely. Every spin cycle repair comes with a written service warranty covering both the replaced parts and the labour, giving you complete peace of mind.',
  },
  {
    q: 'Why does my washing machine vibrate excessively during spin?',
    a: 'Excessive vibration is usually caused by worn shock absorbers, broken suspension springs, or an unbalanced drum. Our technicians diagnose the root cause and fix it to restore smooth, quiet operation.',
  },
];

export default function SpinCycleRepairPage() {
    ...
    <div className="min-h-screen bg-[#FAF9F5] text-neutral-900 flex flex-col font-sans selection:bg-[#f2b134]/30">
      ...
      <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 sm:pt-16 pb-12 sm:pb-20">
        ...
        <nav className="flex items-center gap-2 text-[13px] text-neutral-500 mb-8 sm:mb-12 font-medium">
          ...
          <ChevronRight className="h-3.5 w-3.5" />
          <span className="text-[#c8901f]">Spin Cycle Repair</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          <div className="flex flex-col items-start">
            ...
            <h1 className="font-display font-extrabold text-4xl sm:text-5xl lg:text-[56px] leading-[1.05] tracking-tight text-neutral-900 mb-6">
              ...
              <span className="relative inline-block">
                <span className="relative z-10">Spin Cycle Repair</span>
            ...
            <p className="text-neutral-600 text-[15px] sm:text-[17px] leading-relaxed max-w-xl mb-8">
              Clothes coming out soaking wet, drum won&apos;t spin or violent vibration? Our certified technicians
              diagnose and fix every spin cycle fault — same day, with genuine OEM parts and
          ...
          <div className="relative">
            <div className="relative aspect-[4/3.4] w-full rounded-[2rem] overflow-hidden border border-neutral-200 shadow-2xl">
              <Image
                src="/Spin Cycle Repair Hero Section.png"
                alt="Washing machine spin cycle repair in Dubai"
                fill
      ...
      <section className="w-full bg-white border-t border-b border-neutral-200/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-6">
            {[
              { value: '3,000+', label: 'Spin cycle repairs completed' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mb-14">
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl lg:text-[44px] tracking-tight text-neutral-900 leading-[1.1] mb-4">
              Signs You Need a Spin Cycle Repair
            </h2>
            <p className="text-neutral-600 text-[15px] sm:text-base leading-relaxed">
              If your washing machine shows any of these symptoms, the spin mechanism likely needs
              professional attention. Spotting them early prevents further motor and bearing damage.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="relative order-2 lg:order-1">
            <div className="relative aspect-square w-full rounded-[2rem] overflow-hidden border border-neutral-200 shadow-xl">
              <Image
                src="/What Causes Spin Cycle Problems.png"
                alt="Technician inspecting washing machine spin mechanism"
                fill
          ...
          <div className="order-1 lg:order-2">
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl tracking-tight text-neutral-900 leading-[1.1] mb-6">
              What Causes Spin Cycle Problems?
            </h2>
            <p className="text-neutral-600 text-[15px] sm:text-base leading-relaxed mb-8">
              A washing machine that won&apos;t spin almost always traces back to one of a handful of
          ...
          <div className="lg:hidden relative z-10 flex flex-col gap-6">
            ...
            <div className="flex items-start gap-4">
              <h2 className="font-display font-extrabold text-[26px] sm:text-4xl text-neutral-900 leading-[1.12] tracking-tight flex-1 mt-6 sm:mt-8">
                Washing machine won&apos;t spin? <span className="text-[#c8901f]">We&apos;ll fix it today.</span>
              </h2>
            ...
            <p className="text-neutral-600 text-[15px] sm:text-base leading-relaxed">
              Book a same-day spin cycle repair with Dubai&apos;s trusted technicians. Transparent pricing,
      ...
      <section className="w-full py-20 sm:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl lg:text-[44px] tracking-tight text-neutral-900 leading-[1.1] mb-4">
              Our Spin Cycle Repair Process
            </h2>
            <p className="text-neutral-600 text-[15px] sm:text-base leading-relaxed">
              A clear, six-step process designed to get your washing machine spinning perfectly again —
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-6">
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl lg:text-[44px] tracking-tight text-neutral-900 leading-[1.1] mb-6">
              A Complete Spin Cycle Service
            </h2>
            <p className="text-neutral-600 text-[15px] sm:text-base leading-relaxed mb-10 max-w-lg">
              Every spin cycle repair booking includes a full inspection of the entire spin mechanism — not
          ...
          <div className="lg:col-span-6 relative">
            <div className="relative aspect-[4/3] w-full rounded-[2rem] overflow-hidden border border-neutral-200 shadow-2xl">
              <Image
                src="/Complete Spin Cycle Repair Service.png"
                alt="Washing machine working perfectly after spin cycle repair"
                fill
                sizes="(max-width: 1024px) 100vw, 600px"
                className="object-cover"
              />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl lg:text-[44px] tracking-tight text-neutral-900 leading-[1.1]">
              Dubai&apos;s Spin Cycle Repair Specialists
            </h2>
          </div>
      ...
      <section className="w-full bg-[#FAF9F5] border-t border-neutral-200/60 py-20 sm:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl lg:text-[44px] tracking-tight text-neutral-900 leading-[1.1] mb-6">
              Keep Your Spin Running Smoothly
            </h2>
            <p className="text-neutral-600 text-[15px] sm:text-base leading-relaxed mb-8 max-w-lg">
              A few simple habits keep your washing machine spinning smoothly between professional
              visits — and help you spot trouble before it becomes a costly repair.
            </p>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                { icon: <Filter className="h-5 w-5" />, title: 'Balance Your Loads', desc: 'Distribute clothing evenly in the drum to prevent unbalanced loads that strain the spin mechanism.' },
                { icon: <Waves className="h-5 w-5" />, title: 'Listen for Changes', desc: 'New grinding or squealing sounds during spin often signal belt or bearing wear — catch it early.' },
                { icon: <Droplets className="h-5 w-5" />, title: 'Check Spin Results', desc: 'If clothes come out wetter than usual, the spin speed is dropping — time for a professional check.' },
                { icon: <Gauge className="h-5 w-5" />, title: 'Level Your Machine', desc: 'Ensure all four feet are firmly on the floor to reduce vibration and protect bearings.' },
              ].map((tip) => (
          ...
          <div className="relative">
            <div className="relative aspect-[4/5] w-full rounded-[2rem] overflow-hidden border border-neutral-200 shadow-2xl">
              <Image
                src="/Keep Your Washing Machine Spinning Smoothly.png"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
          <div className="text-left max-w-3xl mb-12">
            <span className="text-[#f2b134] font-mono text-[11px] tracking-widest uppercase mb-3 block">
              SPIN CYCLE DIAGNOSTIC &amp; REPAIR BENCHMARKS
            </span>
            <h2 className="font-display font-bold text-3xl sm:text-4xl text-neutral-900 tracking-tight leading-none mb-4">
              Spin Cycle Fault &amp; Repair Matrix
            </h2>
            <p className="text-neutral-500 text-sm sm:text-base leading-relaxed font-sans">
              A clear breakdown of the most common spin cycle faults we resolve, the genuine OEM parts
              involved, and realistic speed benchmarks for getting your machine spinning again.
            </p>
          </div>
            ...
            <table className="w-full table-auto border-collapse text-left font-sans">
              <thead>
                <tr className="bg-neutral-50/75 border-b border-neutral-200/30 text-neutral-450 text-xs font-mono uppercase tracking-wider">
                  <th className="py-5 px-6 font-bold">Spin Fault</th>
              ...
              <tbody className="text-sm text-neutral-650 divide-y divide-neutral-100">
                {[
                  { num: '01', name: 'Drive Belt Failure', problem: 'Belt snapped or slipping, drum won\'t reach full spin speed or won\'t spin at all.', parts: 'OEM Drive Belt & Tensioner Assembly', speed: 'Same Day', color: 'emerald', pulse: true },
                  { num: '02', name: 'Motor Brush Wear', problem: 'Carbon brushes too short, motor lacks torque — drum spins weakly or intermittently.', parts: 'Motor Carbon Brush Replacement Kit', speed: 'Same Day', color: 'amber', pulse: false },
                  { num: '03', name: 'Bearing Failure', problem: 'Loud grinding noise at high RPM, drum has excessive play and wobble.', parts: 'OEM Drum Bearing & Seal Kit', speed: '24-48 Hours', color: 'blue', pulse: false },
                  { num: '04', name: 'Control Board Fault', problem: 'Erratic spin speed, intermittent stalling mid-cycle, error codes on display.', parts: 'Motor Control Board Replacement & Calibration', speed: '24-48 Hours', color: 'violet', pulse: false },
                  { num: '05', name: 'Suspension Failure', problem: 'Excessive vibration, machine walks across floor during high-speed spin.', parts: 'Shock Absorber & Spring Replacement', speed: 'Same Day', color: 'neutral', pulse: false },
                ].map((row) => (
          ...
          <div className="md:hidden flex flex-col gap-4">
            {[
              { num: '01', name: 'Drive Belt Failure', problem: 'Belt snapped or slipping, drum won\'t reach full spin speed or won\'t spin at all.', parts: 'OEM Drive Belt & Tensioner Assembly', speed: 'Same Day', dotColor: 'bg-emerald-500', badgeBg: 'bg-emerald-50', badgeText: 'text-emerald-700', badgeBorder: 'border-emerald-100/50' },
              { num: '02', name: 'Motor Brush Wear', problem: 'Carbon brushes too short, motor lacks torque — drum spins weakly or intermittently.', parts: 'Motor Carbon Brush Replacement Kit', speed: 'Same Day', dotColor: 'bg-amber-500', badgeBg: 'bg-amber-50', badgeText: 'text-amber-700', badgeBorder: 'border-amber-100/50' },
              { num: '03', name: 'Bearing Failure', problem: 'Loud grinding noise at high RPM, drum has excessive play and wobble.', parts: 'OEM Drum Bearing & Seal Kit', speed: '24-48 Hours', dotColor: 'bg-blue-500', badgeBg: 'bg-blue-50', badgeText: 'text-blue-700', badgeBorder: 'border-blue-100/50' },
              { num: '04', name: 'Control Board Fault', problem: 'Erratic spin speed, intermittent stalling mid-cycle, error codes on display.', parts: 'Motor Control Board Replacement & Calibration', speed: '24-48 Hours', dotColor: 'bg-violet-400', badgeBg: 'bg-violet-50', badgeText: 'text-violet-700', badgeBorder: 'border-violet-100/50' },
              { num: '05', name: 'Suspension Failure', problem: 'Excessive vibration, machine walks across floor during high-speed spin.', parts: 'Shock Absorber & Spring Replacement', speed: 'Same Day', dotColor: 'bg-neutral-500', badgeBg: 'bg-neutral-100', badgeText: 'text-neutral-700', badgeBorder: 'border-neutral-200' },
            ].map((row) => (
      ...
      <section className="w-full bg-[#FAF9F5] pb-24 sm:pb-32 pt-20 sm:pt-28 border-t border-neutral-200/40">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-neutral-500 text-sm sm:text-base leading-relaxed font-sans">
              Get immediate professional answers to common washing machine spin cycle issues and quick diagnostic guidance.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-5 flex flex-col gap-5 text-left">
              ...
              <p className="text-neutral-500 text-[15px] sm:text-base leading-relaxed font-sans max-w-md mt-2">
                Fill in the form and our team will get back to you within 30 minutes. Same-day washing machine spin cycle repair available across all areas in Dubai.
              </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-10">
            ...
            <div className="flex flex-col gap-4">
              ...
              <ul className="flex flex-col gap-2.5 text-neutral-500 text-[13px]">
                ...
                <li className="text-[#f2b134]">Spin Cycle Repair</li>
